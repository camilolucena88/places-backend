...
window.KTLayoutAsideOffcanvas = require('../src/js/layout/base/aside-offcanvas.js');
window.KTLayoutAsideOffcanvasMenu = require('../src/js/layout/base/aside-offcanvas-menu.js');
